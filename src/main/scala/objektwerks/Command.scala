...
final case class ListEntities(license: String, typeof: EntityType, accountId: Long) extends Command with License
...
final case class ListFaults(license: String, accountId: Long) extends Command with License
