...
final class DispatcherTest extends AnyFunSuite with Matchers:
  ...
  var testHouse = House(accountId = 0, location = "100 Rocky Way", label = "label", note = "note", architect = "abc", builder = "def")
  ...
  def updateIssue: Unit =
    testIssue = testIssue.copy(resolution = "foundation repaired", resolved = Entity.now)
